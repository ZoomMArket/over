...
func TestDarwinInstallCreatesLaunchAgentAndExecutable(t *testing.T) {
	...
	target := filepath.Join(home, "Library", "Application Support", "Overlord", "agent")
	...
	plistPath := filepath.Join(home, "Library", "LaunchAgents", "com.overlord.agent.plist")
...
func TestDarwinCustomStartupNameCreatesCustomLabelAndBinary(t *testing.T) {
	...
	target := filepath.Join(home, "Library", "Application Support", "Overlord", "com.example.updater")
